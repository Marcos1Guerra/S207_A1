...
public class TesteCarrinhoCompra {
    ...
    // Teste de comportamento (Padrão 6) carrinho com múltiplos itens e diferentes quantidades
    @Test
    public void testCarrinhoMultiplosItens() throws NumeroNegativoException {
        Brownie bw1 = new Brownie("Brownie Nutella", 2, 150);
        Brownie bw2 = new Brownie("Brownie Doce de Leite", 3, 100);
        Brownie bw3 = new Brownie("Brownie Chocolate", 5, 200);
        ...
        assertEquals(1350, carrinho.somaTotal(), 0.01);
    }
	...
	// Teste inicial básico (Padrão 8) verificando a quantidade total de itens após remoção
    @Test
    ...
    // Teste de comportamento (Padrão 10) verificando o carrinho após resetar (esvaziar)
    @Test
